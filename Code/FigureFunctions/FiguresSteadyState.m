function FiguresSteadyState(StudyData, param, binWidth, Color, removeBias, afterTrialP, earlyValues,lateValues) 
...
FiguresSpatialSS(StudyData, param, binWidth,Color,removeBias, afterTrialP, earlyValues,lateValues);

%% Plot the Temporal Feedback group against the Control group

FiguresTemporalSS(StudyData, param, binWidth,Color,removeBias, afterTrialP, earlyValues,lateValues);
