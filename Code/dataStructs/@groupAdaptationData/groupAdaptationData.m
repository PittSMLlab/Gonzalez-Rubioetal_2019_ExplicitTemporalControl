classdef groupAdaptationData
    ...
    methods
        ...
        function newThis=removeBiasPerception(this, condition,normFlag,adjustFlag)
            
            if nargin<2
                condition=[];
            elseif ~isempty(condition) && length(condition)>1
            ...
            newThis=this;
            for i=1:length(this.ID)
                newThis.adaptData{i}=this.adaptData{i}.removeBiasPerception(condition,normFlag,adjustFlag);
            end
